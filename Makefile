...
clean:
	...
	$(RM) workshop.aux workshop.bbl workshop.blg conference.aux conference.bbl conference.blg demos.aux demos.bbl demos.blg tr.aux tr.bbl tr.blg trs.aux trs.bbl trs.blg
