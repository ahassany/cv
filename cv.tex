...
\homepage{{https://hassany.ps}{hassany.ps}}                         % optional, remove / comment the line if not wanted
...
\item Computer Aided Verification (CAV'17), talk available at \href{https://youtu.be/dUbFWtHLTCI}{https://youtu.be/dUbFWtHLTCI}, July 2017 Heidelberg Germany
\item Workshop on Network Verification \href{http://network-programming.org/wnv/}{http://network-programming.org/wnv/}. April 2017. Palo Alto, CA, US.
\end{itemize}
}
 
\cventry{}{BigBug: Practical Concurrency Analysis for SDN }{}{}{}{\begin{itemize}
\item ACM SIGPLAN conference on Programming Language Design and Implementation (PLDI'16), talk available at \href{https://youtu.be/QzYBOc3G9FU}{https://youtu.be/QzYBOc3G9FU}. June 2016. Santa Barbara, CA, US.
\end{itemize}
}

\cventry{}{SDNRacer: Concurrency Analysis for Software-Defined Networks}{}{}{}{\begin{itemize}
\item ACM Symposium on SDN Research (SOSR). April 2017. Santa Clara, CA, US.
\end{itemize}
}

\cventry{}{UNIS: Design and Implementation of a Unified Network Information Service}{}{}{}{\begin{itemize}
\item IEEE Conference on Services Computing (IEEE SCC). July 2013. Santa Clara, CA US.
\end{itemize}
}
