...
\item Computer Aided Verification (CAV'17), talk available at \httplink[]{hhttps://youtu.be/dUbFWtHLTCI}, July 2017 Heidelberg Germany
\item Workshop on Network Verification  \httplink{hhttp://network-programming.org/wnv/}. April 2017. Palo Alto, CA, US.
\end{itemize}
}
 
\cventry{}{BigBug: Practical Concurrency Analysis for SDN }{}{}{}{\begin{itemize}
\item ACM SIGPLAN conference on Programming Language Design and Implementation (PLDI'16), talk available at \httplink[]{hhttps://youtu.be/QzYBOc3G9FU}. June 2016. Santa Barbara, CA, US.
\end{itemize}
}
...
\item Developed efficient methods for representing data in Haskell's runtime system. Published in \cite{cnf}.
\end{itemize}}

% -------------- ICSI --------------------
\cventry{July 2013 -- Nov. '14}{Research Scientist}{International Computer Science Institute}{Berkeley, CA}{}{\begin{itemize}
\item Worked with Prof. Scott Shenker group on designing and building next generation SDN architecture (SDNv2).
\item Integrated research systems for troubleshoting SDN controllers wtith ONOS; an open source SDN controller \url{http://onosproject.org/}. Published in \cite{scott2014trooubleshooting}.
