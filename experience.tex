...
% -------------- Facebook--------------------
\cventry{Summer '18}{Software Engineer Intern}{Facebook}{Menlo Park, CA, USA}{}{\begin{itemize}
  \item Start practical network verification initiative.
  \item \emph{Technology used:} Python, Mercurial.
\end{itemize}}
...
\cventry{June '15 -- Present}{Research Assistant}{ETH Z\"urich}{Switzerland}{}{\begin{itemize}
  ...
  \item \emph{Technology used:} Python, ONOS, Z3, Satisfiability modulo theories, Git.
\end{itemize}}
...
% -------------- ICSI --------------------
\cventry{July '13 -- Nov. '14}{Research Scientist}{International Computer Science Institute}{Berkeley, CA, USA}{}{\begin{itemize}
\item Worked with Prof. Scott Shenker group on designing and building next generation SDN architecture (SDNv2).
\item Designed and implmented integration plans to implement a research system for quality assurance to run in production with ONOS; a carrier-grade SDN open source network operating system \href{http://onosproject.org/}{http://onosproject.org/}. Published in \cite{scott2014trooubleshooting}.
...
% -------------- ESnet --------------------
\cventry{Summer '13}{Summer Student}{Lawrence Berkeley National Laboratory}{Berkeley, CA, USA}{}{\begin{itemize}
...
\item \emph{Technology used:} Java, Python, Tornado, MongoDB, Git.
\end{itemize}}
...
\item \emph{Technology used:} Java, Python, Tornado, MongoDB, Django, Git.
\end{itemize}}

% --------------- SC -- maybe ignore it --------

% -------------- LBL --------------------
\cventry{Summer '10}{Summer Student}{Lawrence Berkeley National Laboratory}{Berkeley, CA, USA}{}{\begin{itemize}
