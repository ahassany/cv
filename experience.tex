...
\cventry{June '15 -- Present}{Research Assistant}{ETH Z\"urich}{Switzerland}{}{\begin{itemize}
  \item Developed systems to synthesize router configurations from high-level requirements automatically.  \httplink[http://netcomplete.ethz.ch]{http://netcomplete.ethz.ch} \httplink[http://synet.ethz.ch]{http://synet.ethz.ch}. Published in \cite{netcomplete, synet-cav, synet-arxiv}.
  \item Developed a system to detect concurrency violations in production-grade Software-Defined Networks (SDN) controllers.  \httplink[http://sdnracer.ethz.ch]{http://sdnracer.ethz.ch}. Published in \cite{bigbug, sdnracer2, sdnracer}.
  \item \emph{Technology used:} Cisco IOS, BGP, OSPF, Python, SDN, Z3 SMT solver, Git.
\end{itemize}}
...
\item Designed and implemented integration plans to implement a research system for quality assurance to run in production with ONOS; a carrier-grade SDN open-source network operating system. \httplink[http://onosproject.org/]{http://onosproject.org/}. Published in \cite{scott2014trooubleshooting}.
%\item Helped ONOS Quality Assurance team adopt parts of STS in their testing infrastructure.
\item \emph{Technology used:} Python, Java, Continuous Integration QA, Git.
\end{itemize}}
...
\item Developed scalable multi-domain Network Topology Service for dynamic multi-domain network circuits' setup.
...
\item Developed a RESTful Unified Network Information Services (UNIS) to represent topologies for large-scale multi-domain networks.
\item Developed instrumentation and monitoring APIs and tools for GENI experiments and physical infrastructure; \httplink[https://github.com/periscope-ps/unis]{github.com/periscope-ps/unis}.
...
\item Designed a new business process and the required software for issuing building permits in Gaza.
...
\item Software quality assurance of in house built system for registering managing all \emph{.ps} domain names; PNINA is the country code top-level domain (ccTLD) for Palestine.
