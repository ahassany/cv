...
\item Worked with Prof. Scott Shenker's group on designing and building next generation SDN architecture (SDNv2).
...
\item Developed instrumentation and monitoring APIs and tools for GENI \httplink{https://www.geni.net/} experiments and physical infrastructure; \httplink[https://github.com/periscope-ps/unis]{github.com/periscope-ps/unis}.
...
\item \emph{Technologies used:} Visual Basic. NET, Microsoft SQL Server.
\end{itemize}}
