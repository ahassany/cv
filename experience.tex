...
% -------------- Swisscom--------------------
\cventry{Feb. '22 -- Present}{Expert Software Engineer}{Swisscom}{Switzerland}{}{\begin{itemize}
  \item Building Swisscom's network telemetry platform.
  \item Building network real-time anomaly detection system at scale (millions of metrics per minute).
  \item Building real-time streaming platform to transform and normalize network telemetry data at scale (millions of metrics per minute).
  \item Collaborate with IETF to develop new network modeling and telemetry standards~\cite{digitalmap}.
  \item \emph{Technologies used:} Rust, Apache Flink, Apache Druid, Kafka Streams, Java, Python, SNMP, BGP monitoring, IPFIX, NETCONF.
\end{itemize}}


% -------------- Swisscom--------------------
\cventry{Mar. '20 -- Feb. 22}{Senior Software Engineer}{Swisscom}{Switzerland}{}{\begin{itemize}
  ...
  \item Designing and building near-real-time time streaming ETL pipelines.
  ...
  \item Co/supervised 4 master's students in collaboration with Swisscom Digital Lab and EPFL Lausanne. Their projects were in graph embedding and network modeling.
  \item Active role in solving technical challenges across different teams, aligning product priorities with management, and mentoring students and junior engineers.
  \item \emph{Technologies used:} Graph DB, Neo4j, Kafka Streams, Spring Boot, Java, Python, Ansible, Gradle, Jenkins.
\end{itemize}}
